...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 18 Jan 2024 pada 15.19
...
(11, '2024-01-18', 'POLI', 'Display-Speaker', 'Perlu dirapikan kabel yang melintang'),
(12, '2024-01-18', 'LOKET', 'Display-Speaker-Minipc-Kesehatan CPU', 'Speaker perlu diganti'),
(13, '2024-01-18', 'IGD', 'Display-Speaker-Donggle HDMI-Kesehatan CPU', ''),
(14, '2024-01-18', 'KAMAR OPERASI', 'Display-Network-Kesehatan CPU', 'Perlu diganti tv nya'),
(15, '2024-01-18', 'FARMASI', 'Display-Info Kamar-Network-Kabel LAN', 'Komputernya perlu di ganti');
...
INSERT INTO `users` (`id_user`, `nama`, `username`, `password`, `level`, `aktif`) VALUES
(2, 'Paskalis', 'paskal', '$2a$12$JZgH93i/3YaZmouhIWvZouv6oSKWwMCJskDYoWi014uffnTBrzxnq', 'captain', '1'),
(3, 'irene', 'Iren', '$2a$12$a8iIodPf8mpMs7NUd53Qr.GyE5poTcQnOIkFLlF8QQkKR9jMZpv8a', 'crew', '1'),
(5, 'Mislina', 'mis', '$2y$10$uqjP2OM1heAcKK1B7.nLtuiHjPDrYn81ocZkauAz6YV62uKR3LGxS', 'crew', '1'),
(6, 'Jeri Sutayo', 'jeri', '$2y$10$2xpASenfg774Fibnw7hx.eGO2SlxgvNQ918GKYc.55AQP.PZOCKIa', 'crew', '0');
...
--
ALTER TABLE `patroli`
  MODIFY `id_patroli` int(5) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=16;
